...
export class VagabondActiveEffect extends ActiveEffect {
  ...
  static getAttributeChoices() {
    const choices = {
      ...
      // -- Brawl/Grapple/Shove Flags --
      'system.brawlCheckFavor': 'Brawl: Favor on Grapple/Shove Checks',
      'system.fisticuffs': 'Brawl: Fisticuffs (Post-Hit Grapple/Shove)',
      'system.shoveSizeOverride': 'Brawl: Shove Size Override (large/huge)',
      'system.hasBully': 'Brawl: Bully Perk',
      ...
      'system.hasEvasive': 'Rogue: Evasive (ignore Reflex Hinder, drop 2 dice on Dodge)',
      'system.hasRage': 'Barbarian: Rage (die upsize + explode + DR while Berserk)',
      'system.rageDamageReduction': 'Barbarian: Rage Damage Reduction per Die (1 or 2)',
      'system.hasRipAndTear': 'Barbarian: Rip and Tear (upgraded Rage)',
      'system.hasAggressor': 'Barbarian: Aggressor (+10 speed round 1)',
      ...
      'system.incomingMeleeAttacksModifier': 'Status: Incoming Melee Attacks Modifier',
